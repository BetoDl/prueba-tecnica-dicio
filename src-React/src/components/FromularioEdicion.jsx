...
/*
Componente: FromularioEdicion
Descripción: Componente encargado de cargar los datos en Inputs de manera que puedan ser editados 
Muy parecido al formulario Alta sólo com cambios de css
*/

export default function FromularioEdicion({ datosIniciales }) {
    //Declaración de States
    const [id_usuario, setId_usuario] = useState(datosIniciales.id);
    const [nombre, setNombre] = useState(datosIniciales.nombre);
    const [paterno, setPaterno] = useState(datosIniciales.apellidoPaterno);
    const [materno, setMaterno] = useState(datosIniciales.apellidoMaterno);
    const [edad, setEdad] = useState(datosIniciales.edad);
    const [email, setEmail] = useState(datosIniciales.email);
    const [fecha, setFecha] = useState(datosIniciales.fechaNac);
    //datos de variable Datos, los cuales pueden venir null y dar error, se inicializarán una vez montado el componente
    ...
    function enviarDatos(e) {
        ...
        const url = "https://api.devdicio.net:8444/v1/sec_dev_interview/" + id_usuario;
        axios({
            url: url,
            method: "PUT",
            data: (datos),
    ...
    return (
        <div className='FromularioAlta_general col-12'>
